        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Button
              variant="ghost"
              size="icon"
              className="relative hover-lift glass"
            ...
            <Button
              ...
              size="icon"
              onClick={toggleTheme}
              className="hover-lift glass hover:glow-cyan"
              aria-label={theme === "dark" ? "التبديل إلى الوضع المضيء" : "التبديل إلى الوضع المظلم"}
            >
              {theme === "dark" ? (
            ...
            <Button
              variant="outline"
              size="icon"
              className="hover-lift glass hover:glow-purple"
