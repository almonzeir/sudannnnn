      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Button variant="ghost" size="icon" onClick={toggleTheme} className="hover-lift glass hover:glow-cyan" aria-label="تبديل الوضع الليلي">
              {theme === "dark" ? (
          ...
          <div className="lg:hidden py-4 border-t border-border/50">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between py-2 px-2">
                ...
                <Button variant="ghost" size="icon" onClick={toggleTheme} aria-label="تبديل الوضع الليلي">
                  {theme === "dark" ? (
                    <Sun className="w-5 h-5" />
                  ) : (
                    <Moon className="w-5 h-5" />
