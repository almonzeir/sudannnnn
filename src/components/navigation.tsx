      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Button variant="ghost" size="icon" className="relative hover-lift glass" aria-label="التنبيهات">
            ...
            <Button variant="ghost" size="icon" onClick={toggleTheme} className="hover-lift glass hover:glow-cyan" aria-label="تبديل السمة">
              {theme === "dark" ? (
